# target-beacon-sidecar-baseline Specification

## Purpose
Define the A-owned target UHF Beacon sidecar baseline that supplies reviewable
remote capture metadata to manual Mission Console surfaces without allowing
their functional path to mutate shared target services.
## Requirements
