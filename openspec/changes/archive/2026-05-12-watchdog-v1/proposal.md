...
- Affected docs/evidence: new `docs/test-records/watchdog-v1/README.md`, verification-path registry updates, and active-baseline architecture/roadmap truth updates.
