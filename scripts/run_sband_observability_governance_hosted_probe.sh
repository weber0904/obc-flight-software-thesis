...
PROBE_TMP_DIR="${PROBE_TMP_DIR:-$(mktemp -d "/tmp/sband-observability-governance-hosted.XXXXXX")}"
...
"${PYTHON_BIN}" "${ROOT_DIR}/scripts/sband_observability_governance_hosted_probe.py"
