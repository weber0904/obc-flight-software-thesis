...
PROBE_TMP_DIR="${PROBE_TMP_DIR:-$(mktemp -d "/tmp/challenge-handshake-secure-command-hosted.XXXXXX")}"
...
"${PYTHON_BIN}" "${ROOT_DIR}/scripts/challenge_handshake_secure_command_hosted_probe.py"
