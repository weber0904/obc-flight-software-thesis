...
- dedicated target TCP helper:
  [scripts/comm_verification/lib/run_target_tcp_matrix_probe.py](../../../scripts/comm_verification/lib/run_target_tcp_matrix_probe.py)
- dedicated remote stack launchers:
  - [scripts/comm_verification/lib/run_target_tcp_obc_stack.sh](../../../scripts/comm_verification/lib/run_target_tcp_obc_stack.sh)
  - [scripts/comm_verification/lib/run_target_tcp_subsystem_stack.sh](../../../scripts/comm_verification/lib/run_target_tcp_subsystem_stack.sh)
- dedicated target TCP case entrypoints:
  - [scripts/comm_verification/cases/csp-reachability.sh](../../../evidence/verification-path-registry.md)
  - [scripts/comm_verification/cases/sband-command.sh](../../../evidence/verification-path-registry.md)
  - [scripts/comm_verification/cases/sband-file.sh](../../../evidence/verification-path-registry.md)
  - [scripts/comm_verification/cases/uhf-primary-command.sh](../../../evidence/verification-path-registry.md)
  - [scripts/comm_verification/cases/uhf-primary-file.sh](../../../evidence/verification-path-registry.md)
