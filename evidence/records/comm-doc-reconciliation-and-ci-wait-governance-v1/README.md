...
- `evidence/records/comm-csp-node-and-ground-gateway-v1/README.md`
- `evidence/records/comm-simulator-foundation-v1/README.md`
- `evidence/records/subsystem-comm-uart-link-preflight-v1/README.md`
- `evidence/records/comm-lab-serial-acquisition-v1/README.md`
- `evidence/records/ttc-over-comm-lab-serial-ingress-v1/README.md`
