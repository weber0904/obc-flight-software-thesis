...
- the thesis-backed sequence campaign on 2026-07-20 retained functional PASS
  ...
  live under
  [2026-07-20-route1-target-abc-rerun](../chapter5-integrated-route-closure-v1/ARTIFACTS.json).
...
- reused summary input:
  `$REPO_ROOT/evidence/records/chapter5-integrated-route-closure-v1/artifacts/2026-06-28-formal-rerun/route1/target/external-roots/payload-raw-preview-dual-artifact-v1-target.xw9FPi/case/payload-raw-preview-dual-artifact-target-summary.json`
