...
- default hosted CCSDS S-band node-5 path: `evidence/verification-path-registry.md` entry 43
- active hosted UHF CCSDS node-6 path: `evidence/verification-path-registry.md` entry 43A
- hosted dual-link COMM simulator identity and generic node-4 compatibility path: `evidence/verification-path-registry.md` entry 37
