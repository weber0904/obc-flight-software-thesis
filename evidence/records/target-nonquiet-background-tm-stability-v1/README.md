...
- [scripts/run_target_can_node6_nonquiet_diagnosis_probe.sh](../../../evidence/verification-path-registry.md)
...
- [scripts/run_subsystem_csp_service.sh](../../../scripts/run_subsystem_csp_service.sh)
