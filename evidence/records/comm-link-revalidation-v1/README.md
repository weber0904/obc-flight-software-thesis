...
- focused shared-sequence helper evidence:
  [evidence/records/comm-verification-sequence-subsystem-harness-v1/README.md](../comm-verification-sequence-subsystem-harness-v1/README.md)
...
- focused target TCP evidence:
  [evidence/records/target-tcp-southbound-parity-foundation-v1/README.md](../target-tcp-southbound-parity-foundation-v1/README.md)
- focused target TCP high-level closure evidence:
  [evidence/records/target-tcp-matrix-closure-v1/README.md](../target-tcp-matrix-closure-v1/README.md)
- focused target direct-control evidence:
  [evidence/records/target-direct-control-matrix-cases-v1/README.md](../target-direct-control-matrix-cases-v1/README.md)
...
- focused target CAN evidence:
  [evidence/records/target-can-node6-matrix-closure-v1/README.md](../target-can-node6-matrix-closure-v1/README.md)
- focused target direct-control evidence:
  [evidence/records/target-direct-control-matrix-cases-v1/README.md](../target-direct-control-matrix-cases-v1/README.md)
