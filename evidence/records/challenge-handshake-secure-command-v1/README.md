...
- [scripts/run_challenge_handshake_secure_command_hosted_probe.sh](../../../scripts/run_challenge_handshake_secure_command_hosted_probe.sh)
- [scripts/challenge_handshake_secure_command_hosted_probe.py](../../../scripts/challenge_handshake_secure_command_hosted_probe.py)
...
- [evidence/records/uhf-primary-packet-quiet-decoupling-v1/README.md](../uhf-primary-packet-quiet-decoupling-v1/README.md)
- [evidence/records/uhf-ccsds-hosted-adoption-v1/README.md](../uhf-ccsds-hosted-adoption-v1/README.md)
- [evidence/records/command-auth-envelope-v1/README.md](../command-auth-envelope-v1/README.md)
- [evidence/records/command-session-lifecycle-v1/README.md](../command-session-lifecycle-v1/README.md)
