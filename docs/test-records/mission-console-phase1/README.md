...
- the current target auth failure snapshot for later rerun comparison:
  - [target-auth-failure-snapshot-2026-06-20.md]($REPO_ROOT/docs/test-records/mission-console-phase1/target-auth-failure-snapshot-2026-06-20.md)
...
- [docs/test-records/mission-console-beacon-viewer-v1/README.md](../mission-console-beacon-viewer-v1/README.md)
...
- the current Mission Console manual operator flow is documented in:
  - [`docs/operator/mission-console-phase1-runbook.md`](../../operator/mission-console-phase1-runbook.md)
  - [`docs/operator/mission-console-phase1-runbook.zh-TW.md`](../../operator/mission-console-phase1-runbook.zh-TW.md)
