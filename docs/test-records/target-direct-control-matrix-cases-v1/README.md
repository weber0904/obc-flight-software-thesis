...
- helper:
  [scripts/comm_verification/lib/run_target_direct_matrix_probe.py]($REPO_ROOT/scripts/comm_verification/lib/run_target_direct_matrix_probe.py)
- matrix case entrypoint:
  [scripts/comm_verification/cases/direct-control.sh]($REPO_ROOT/scripts/comm_verification/cases/direct-control.sh)
