...
- historical ADCS `R2` target restart evidence in
  [docs/test-records/target-recovery-closure-v1/README.md](../target-recovery-closure-v1/README.md)
- target hardware-watchdog board-reset evidence in
  [docs/test-records/target-hardware-watchdog-reset-proof-v1/README.md](../target-hardware-watchdog-reset-proof-v1/README.md)
