...
- Entry `34` in `docs/verification-path-registry.md` for hosted official FDP
  parity ancestry
- Entry `44` in `docs/verification-path-registry.md` for default hosted CCSDS
  S-band official FDP parity ancestry
- `docs/test-records/reliable-transfer-v1/README.md` for the maintained bounded
...
- Verdict: `PASS`
- Summary: [build-artifacts/verification-ci-local/summary.md]($REPO_ROOT/build-artifacts/verification-ci-local/summary.md)
- Key checkpoints:
  - `01_generate`: `PASS`
  - `02_build`: `PASS`
  - `03_generate_ut`: `PASS`
