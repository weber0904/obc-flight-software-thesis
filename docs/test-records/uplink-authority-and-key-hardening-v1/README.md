...
- [scripts/uplink_authority_and_key_hardening_hosted_probe.py]($REPO_ROOT/scripts/uplink_authority_and_key_hardening_hosted_probe.py)
...
- [docs/test-records/challenge-handshake-secure-command-v1/README.md](../challenge-handshake-secure-command-v1/README.md)
- [docs/test-records/official-sequencing-system-resources-v1/README.md](../official-sequencing-system-resources-v1/README.md)
