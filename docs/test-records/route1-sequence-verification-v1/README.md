...
the [frozen target observation root](../chapter5-integrated-route-closure-v1/artifacts/2026-07-20-route1-target-abc-rerun/README.md).
...
[`dedup-manifest.json`](../chapter5-integrated-route-closure-v1/artifacts/2026-07-20-route1-target-abc-rerun/dedup-manifest.json).
...
docs/verification-debugging-lessons.md is diagnostic context, not this
