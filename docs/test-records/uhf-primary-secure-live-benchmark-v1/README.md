...
- [scripts/run_target_uhf_primary_secure_live_benchmark.sh]($REPO_ROOT/scripts/run_target_uhf_primary_secure_live_benchmark.sh)
- [scripts/comm_verification/lib/run_target_uhf_primary_secure_live_benchmark.py]($REPO_ROOT/scripts/comm_verification/lib/run_target_uhf_primary_secure_live_benchmark.py)
...
- quiet result:
  [paired-rerun-2/quiet-command/result.json]($REPO_ROOT/build-artifacts/uhf-primary-secure-live-benchmark/20260603T-final-3-converged/paired-rerun-2/quiet-command/result.json)
- nonquiet result:
  [paired-rerun-2/nonquiet-command/result.json]($REPO_ROOT/build-artifacts/uhf-primary-secure-live-benchmark/20260603T-final-3-converged/paired-rerun-2/nonquiet-command/result.json)
- representative nonquiet failure:
  [paired-rerun-1/nonquiet-command/result.json]($REPO_ROOT/build-artifacts/uhf-primary-secure-live-benchmark/20260603T-final-3-converged/paired-rerun-1/nonquiet-command/result.json)
...
- canonical UHF event evidence:
  [paired-rerun-2/nonquiet-command/uhf-ground/native-cli/event.log]($REPO_ROOT/build-artifacts/uhf-primary-secure-live-benchmark/20260603T-final-3-converged/paired-rerun-2/nonquiet-command/uhf-ground/native-cli/event.log)
- canonical UHF channel evidence:
  [paired-rerun-2/nonquiet-command/uhf-ground/native-cli/channel.log]($REPO_ROOT/build-artifacts/uhf-primary-secure-live-benchmark/20260603T-final-3-converged/paired-rerun-2/nonquiet-command/uhf-ground/native-cli/channel.log)
- UHF raw downlink capture:
  [paired-rerun-2/nonquiet-command/captures/uhf/southbound-to-gds.bin]($REPO_ROOT/build-artifacts/uhf-primary-secure-live-benchmark/20260603T-final-3-converged/paired-rerun-2/nonquiet-command/captures/uhf/southbound-to-gds.bin)
