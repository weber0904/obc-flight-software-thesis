...
- [artifacts/2026-07-09-demo-ready](./artifacts/2026-07-09-demo-ready)

Hosted proof files:

- [hosted-manifest.json](./artifacts/2026-07-09-demo-ready/hosted/hosted-manifest.json)
- [dashboard.json](./artifacts/2026-07-09-demo-ready/hosted/dashboard.json)
- [beacon-latest.json](./artifacts/2026-07-09-demo-ready/hosted/beacon-latest.json)
- [beacon-history.json](./artifacts/2026-07-09-demo-ready/hosted/beacon-history.json)

Target proof files:

- [target-manifest.json](./artifacts/2026-07-09-demo-ready/target/target-manifest.json)
- [dashboard.json](./artifacts/2026-07-09-demo-ready/target/dashboard.json)
- [beacon-latest.json](./artifacts/2026-07-09-demo-ready/target/beacon-latest.json)
- [beacon-history.json](./artifacts/2026-07-09-demo-ready/target/beacon-history.json)
...
- [docs/test-records/uhf-uart-backup-link-v1/README.md](../uhf-uart-backup-link-v1/README.md)
- [docs/test-records/uhf-beacon-suppression-runtime-v1/README.md](../uhf-beacon-suppression-runtime-v1/README.md)
- [docs/test-records/mission-console-phase1/README.md](../mission-console-phase1/README.md)
