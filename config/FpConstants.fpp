...
# Project-local override: widen command strings to carry SHA-256 hex.
# ======================================================================
...
constant FW_CMD_STRING_MAX_SIZE = 64
...
@ Keep file packets aligned with the V3 one-frame transport envelope so a
@ serialized stock file packet fits in one CSP buffer on node-5 COMM_CSP.
constant FW_FILE_BUFFER_MAX_SIZE = 2032
